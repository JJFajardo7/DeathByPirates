...
else if(keyboard_check(ord("W")) && (!(keyboard_check(ord("D"))) || !(keyboard_check(ord("A"))))){
	image_angle = 180;
}
else if(keyboard_check(ord("S")) && (!(keyboard_check(ord("D"))) || !(keyboard_check(ord("A"))))){
	image_angle = 0;
}
...
if (cd <= 0 && mouse_check_button(mb_left)&& can_shoot == true) {
	cd = cdValue;
	can_shoot = false;
	alarm_set(0, 60);
